...
namespace MGroup.Solvers.DDM.Prototypes.Tests.PFetiDP
{
	public static class PFetiDPSolverTests
	{
		...
		[InlineData(PsmInterfaceProblem.Distributed, FetiDPCoarseProblem.DistributedReortho, PFetiDPScaling.HomogeneousDistributed, PFetiDPPreconditioner.DistributedAll)]
