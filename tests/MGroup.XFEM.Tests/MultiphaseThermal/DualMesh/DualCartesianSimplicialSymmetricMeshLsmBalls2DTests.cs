...
{
	public static class DualCartesianSimplicialSymmetricMeshLsmBalls2DTests
	{
		private static readonly string outputDirectory = Path.Combine(
			Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName, 
			"Resources", "dual_cartesian_simplicial_symmetric_mesh_lsm_balls_2D_temp");
		private static readonly string expectedDirectory = Path.Combine(
			Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName, 
			"Resources", "dual_cartesian_simplicial_symmetric_mesh_lsm_balls_2D");

		private static readonly int dim = 2;
		private static readonly double[] minCoords = { 0.0, 0.0 };
		private static readonly double[] maxCoords = { 7.0, 5.0 };
		private static readonly int[] numNodesCoarse = { 7, 5 };
		private static readonly int[] numNodesFine = { 13, 9 };
		private static readonly Circle2D initialCurve = new Circle2D(3.5, 2.5, 2.0);
		...
		public static void TestLevelSetsAtRandomPoints()
		{
			try
			{
				...
				var mesh = new DualCartesianSimplicialSymmetricMesh2D.Builder(minCoords, maxCoords, numNodesCoarse, numNodesFine)
					.BuildMesh();
		...
		public static void TestModel()
		{
			try
			{
				...
				var mesh = new DualCartesianSimplicialSymmetricMesh2D.Builder(minCoords, maxCoords, numNodesCoarse, numNodesFine).BuildMesh();
