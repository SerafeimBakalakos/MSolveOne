	...
	public static class DualCartesianMeshLsmBalls3DTests
	{
		...
		public static void TestIndividualMeshesLevelSets()
		{
			try
			{
				...
				var coarseLsm = new SimpleLsm3D(0, coarseModel.Nodes.Values.OrderBy(n => n.ID).ToList(), initialSurface);
				...
				var fineLsm = new SimpleLsm3D(0, fineModel.Nodes.Values.OrderBy(n => n.ID).ToList(), initialSurface);
