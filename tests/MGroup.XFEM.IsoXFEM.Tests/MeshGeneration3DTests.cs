namespace MGroup.XFEM.IsoXFEM.Tests
{
	...
	public class MeshGeneration3DTests
	{
		...
		//	var nodesExpected = new List<XNode>();
		//	nodesExpected.Add(new XNode(0, new double[] { 0, 0, 0 }));
		//	nodesExpected.Add(new XNode(1, new double[] { 10, 0, 0 }));
		//	nodesExpected.Add(new XNode(2, new double[] { 20, 0, 0 }));
		//	nodesExpected.Add(new XNode(3, new double[] { 0, 10, 0 }));
		//	nodesExpected.Add(new XNode(4, new double[] { 10, 10, 0 }));
		//	nodesExpected.Add(new XNode(5, new double[] { 20, 10, 0 }));
		//	nodesExpected.Add(new XNode(6, new double[] { 0, 20, 0 }));
		//	nodesExpected.Add(new XNode(7, new double[] { 10, 20, 0 }));
		//	nodesExpected.Add(new XNode(8, new double[] { 20, 20, 0 }));
		//	nodesExpected.Add(new XNode(9, new double[] { 0, 0, 10 }));
		//	nodesExpected.Add(new XNode(10, new double[] { 10, 0, 10 }));
		//	nodesExpected.Add(new XNode(11, new double[] { 20, 0, 10 }));
		//	nodesExpected.Add(new XNode(12, new double[] { 0, 10, 10 }));
		//	nodesExpected.Add(new XNode(13, new double[] { 10, 10, 10 }));
		//	nodesExpected.Add(new XNode(14, new double[] { 20, 10, 10 }));
		//	nodesExpected.Add(new XNode(15, new double[] { 0, 20, 10 }));
		//	nodesExpected.Add(new XNode(16, new double[] { 10, 20, 10 }));
		//	nodesExpected.Add(new XNode(17, new double[] { 20, 20, 10 }));
		//	nodesExpected.Add(new XNode(18, new double[] { 0, 0, 20 }));
		//	nodesExpected.Add(new XNode(19, new double[] { 10, 0, 20 }));
		//	nodesExpected.Add(new XNode(20, new double[] { 20, 0, 20 }));
		//	nodesExpected.Add(new XNode(21, new double[] {  0, 10, 20 }));
		//	nodesExpected.Add(new XNode(22, new double[] { 10, 10, 20 }));
		//	nodesExpected.Add(new XNode(23, new double[] { 20, 10, 20 }));
		//	nodesExpected.Add(new XNode(24, new double[] {  0, 20, 20 }));
		//	nodesExpected.Add(new XNode(25, new double[] { 10, 20, 20 }));
		//	nodesExpected.Add(new XNode(26, new double[] { 20, 20, 20 }));
		//	for (int i = 0; i < nodesExpected.Count; i++)
		//	{
		//		Assert.Equal(nodesExpected[i].ID, nodesComputed[i].ID);
