...
namespace MGroup.FEM.Tests.IntegrationTests
{
	...
	public class EulerBeam2DLinearTest
	{
		...
		public void TestEulerBeam2DLinearBendingExample()
		{
			...
			// Solver
			//var solverFactory = new MSolve.Solvers.Iterative.PcgSolver.Builder(
			...
			double solutionNorm = solver.LinearSystem.Solution.Norm2();
			double rhsNorm = solver.LinearSystem.RhsVector.Norm2();

			Assert.Equal(31.388982074929341, solver.LinearSystem.Solution.SingleVector[4], 12);
		}
	}
}
