...
namespace MGroup.FEM.Tests.IntegrationTests
{
	...
	public static class Shell8andCohesiveNonLinear
	{
		...
		{
			var expectedDisplacements = new double[5][]; //TODO: this should be 11 EINAI ARRAY APO DICTIONARIES
	...
	-3.074281618479765600e-05, 1.064926767853693300e-05, -3.846254167901110600e-05, -3.069737876082750600e-05, -1.191596225034872200e-04 };
		...
		private static TotalDisplacementsPerIterationLog SolveModel()
		{
			...
			//var solverFactory = new Solvers.Dense.DenseMatrixSolver.Builder();
			//solverFactory.DofOrderer = new DofOrderer(new SimpleDofOrderingStrategy(), new NullReordering());
