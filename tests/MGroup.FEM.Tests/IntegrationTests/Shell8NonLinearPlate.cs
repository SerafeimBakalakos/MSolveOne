...
namespace MGroup.FEM.Tests.IntegrationTests
{
	...
	public static class Shell8NonLinearPlate
	{
		...
		{
			var expectedDisplacements = new double[4][]; //TODO: this should be 11 EINAI ARRAY APO DICTIONARIES
	...
	-7.066535263910381200e-10, -7.066531664241640700e-10, 4.128219398586412200e-16, 2.340064775305142000e-18, 1.940763490936303600e-05 };
		...
		private static TotalDisplacementsPerIterationLog SolveModel()
		{
			...
			watchDofs.Add((model.NodesDictionary[7], StructuralDof.TranslationX));
			watchDofs.Add((model.NodesDictionary[9], StructuralDof.TranslationY));
			watchDofs.Add((model.NodesDictionary[13], StructuralDof.RotationX));
			watchDofs.Add((model.NodesDictionary[18], StructuralDof.TranslationX));
			watchDofs.Add((model.NodesDictionary[30], StructuralDof.TranslationZ));
