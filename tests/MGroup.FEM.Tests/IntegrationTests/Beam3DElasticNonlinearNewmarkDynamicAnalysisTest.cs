	...
	public class Beam3DElasticNonlinearNewmarkDynamicAnalysisTest
	{
		private static void TestBeam3DElasticNonlinearNewmarkDynamicAnalysisExample()
		{
			...
			for (int iElem = 0; iElem < nElems; iElem++)
			{
				...
				var beam = new Beam3DCorotationalQuaternion(elementNodes, youngModulus, poissonRatio, density, beamSection);
			...
			var parentAnalyzerBuilder = new NewmarkDynamicAnalyzer.Builder(model, algebraicModel, solver, provider, childAnalyzer, 0.28, 3.36);
			...
			Assert.Equal(148.936792350562, solver.LinearSystem.RhsVector.SingleVector[7], 12);
		}
	}
}
