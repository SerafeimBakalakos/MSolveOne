...
{
	public class PFetiDPPreconditionerDistributedInterface : IPFetiDPPreconditioner
	{
		...
		private IVectorMultipliable Ac;

		public void Calculate()
		{
			BlockMatrix Lce = coarseProblem.MatrixLce;
			...
			Lce.ColMultiplicities = multiplicities;
			...
			this.Ac = new MatrixProduct(Lce, BlockMatrix.CreateSingle(invScc), Lce.Transpose());
		}
