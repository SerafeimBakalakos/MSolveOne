...
{
	public class FetiDPCoarseProblemDistributedReortho : FetiDPCoarseProblemDistributed
	{

		public FetiDPCoarseProblemDistributedReortho(IModel model, FetiDPSubdomainDofs dofs, 
...

		{
			...
			iterativeSolverBuilder.ResidualTolerance = 0.02 * pcgResidualTolerance;
