...
namespace MGroup.XFEM.IsoXFEM
{
    public class GeometryProperties
    {
        ...
        /// <summary>
        /// Constructs a Geometry object and initializes it with its length, height and thickness dimensions and numberOfElements X and Y in order to create the mesh of the model.
        /// </summary>
