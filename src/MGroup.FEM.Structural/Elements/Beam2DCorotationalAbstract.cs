...
namespace MGroup.FEM.Structural.Elements
{
	public abstract class Beam2DCorotationalAbstract : IFiniteElement
	{
		...
		protected Beam2DCorotationalAbstract(IList<Node> nodes, double youngModulus, double poissonRatio, double density, BeamSection2D beamSection)
		{
			this.nodes = nodes;
		...
		public Tuple<double[], double[]> CalculateStresses(IElement element, double[] localdDisplacements)
		{
