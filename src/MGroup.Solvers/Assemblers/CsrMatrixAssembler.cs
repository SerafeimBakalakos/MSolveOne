...
namespace MGroup.Solvers.Assemblers
{
	...
	{
		private const string name = "CsrMatrixAssembler"; // for error messages
		...
		/// </param>
		public CsrMatrixAssembler(bool isSymmetric, bool sortColsOfEachRow = true)
		{
		...
		public ISubdomainMatrixAssembler<CsrMatrix> Clone() => new CsrMatrixAssembler(isSymmetric, sortColsOfEachRow);
