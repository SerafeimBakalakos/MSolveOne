...
{
    public class CrackSurfaceExtensionNormals3DObserver : ICrackObserver
    {
        ...
        public CrackSurfaceExtensionNormals3DObserver(CrackSurface3D crack, string outputDirectory, bool plotPseudoNormals)
        {
            this.crack = crack;
