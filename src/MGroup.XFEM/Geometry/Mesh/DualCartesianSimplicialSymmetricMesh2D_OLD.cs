...
namespace MGroup.XFEM.Geometry.Mesh
{
	...
	/// </summary>
	public class DualCartesianSimplicialSymmetricMesh2D_OLD : DualCartesianSimplicialSymmetricMeshBase_OLD
	{
		private DualCartesianSimplicialSymmetricMesh2D_OLD(UniformCartesianMesh2D coarseMesh, UniformSimplicialSymmetricMesh2D fineMesh)
		...
		public class Builder
		{
			...
			public DualCartesianSimplicialSymmetricMesh2D_OLD BuildMesh()
			{
				...
				var fineMesh = new UniformSimplicialSymmetricMesh2D.Builder(minCoordinates, maxCoordinates, numNodesFine)
					...
					.BuildMesh();
				return new DualCartesianSimplicialSymmetricMesh2D_OLD(coarseMesh, fineMesh);
			}
		}
	}
}
