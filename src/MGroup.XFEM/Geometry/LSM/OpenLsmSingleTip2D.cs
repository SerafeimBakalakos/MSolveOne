...
{
	public class OpenLsmSingleTip2D : ISingleTipLsmGeometry, IImplicitCrackGeometry
	{
		...
		public double[] GetNodalLevelSets(XNode node) => new double[] { LevelSetsBody[node.ID], LevelSetsTip[node.ID] };
