...
namespace MGroup.MSolve.Meshes.Structured
{
	...
	public class UniformSimplicialSymmetricMesh2D : IStructuredMesh
	{
		...
		/// <summary>
		/// Coordinates of the nodes of a Quad9 element in its natural system. They are integers on purpose.
		/// </summary>
		private static readonly int[][] quad9NodeCoords = new int[9][]
		{
			new int[] { -1, -1 }, // N0
			new int[] { +1, -1 }, // N1
			new int[] { +1, +1 }, // N2
		...
		/// <summary>
		/// Given the index (i,j) of the first node of a Quad9 with coordinates=(-1,-1), this list contains, for each subtriangle 
			...
			int axisMinor, int firstNodeID, int firstElementID)
		{
			...
			elementNodeIdxOffsets.Add(GetNodeIdxOffsetsOfTriangle(new int[] { 8, 0, 1 })); // Triangle 0: N8-N0-N1 
			elementNodeIdxOffsets.Add(GetNodeIdxOffsetsOfTriangle(new int[] { 8, 1, 2 })); // Triangle 1: N8-N1-N2 
			elementNodeIdxOffsets.Add(GetNodeIdxOffsetsOfTriangle(new int[] { 8, 2, 3 })); // Triangle 2: N8-N2-N3 
			elementNodeIdxOffsets.Add(GetNodeIdxOffsetsOfTriangle(new int[] { 8, 3, 0 })); // Triangle 3: N8-N3-N0 
		}
